...
const CarDetail = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="container-fluid blank-container"></div>
            ...
            <div className="card-body">
              ...
              <div className="mt-4">
                ...
                <ul className="ps-4">
                  ...
                  <li className="content-detail-text ">Jika overtime lebih dari 12 jam akan ada tambahan biaya Rp 20.000/jam</li>
