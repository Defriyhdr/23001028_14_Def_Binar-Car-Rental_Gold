  ...
  async function handleUpload() {
    ...
    try {
      const response = await axios.put(
        `https://api-car-rental.binaracademy.org/customer/order/${order.list_date.id}/slip`,
        formData,
        config
      );
            ...
            <div className="account-number d-flex justify-content-between">
              <p>
                ...
                {new Intl.NumberFormat("id-ID", {
                  style: "decimal",
                  currency: "IDR",
                }).format(order.list_date.total_price)}
              </p>
              <CopyIcon w={5} h={5} />
            </div>
            <br />
                ...
                <TabPanels>
                  <TabPanel>
                    <ul>
                      ...
                      <li>
                        <p>Masukkan nomor BCA Virtual Account: 70020+Order ID</p>
                      </li>
                      <p>Contoh:</p>
        ...
        <div className="col-md-6">
          {isConfirmPayment ? (
            <div className="card shadow-card mt-4 px-4 py-3">
              ...
              <div className="mt-3">
                <p>
                  Terima kasih telah melakukan konfirmasi pembayaran. <br /> Pembayaranmu akan
              ...
              <Button
                ...
                disabled={image !== initImage ? false : true}
              >
                <b>Upload</b>
              </Button>
            </div>
            ...
            <div className="card shadow-card mt-4 px-4 py-3">
              <p id="description-confirm-payment">
